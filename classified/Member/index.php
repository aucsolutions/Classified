<?php
	...
	if ( $_POST )
	{
		...
		$admin_detail = $data->select ( "Account" , "*" , array ( "EmailAddress" => addslashes ( $post_array["txtEmailAddress"] ) , "Password" => $post_array["psd_password"] , "IsEnable" => 1 ) ) ;
		
		if ( ! empty ( $admin_detail ) )
		{
			$admin_detail = $admin_detail[0] ;
			$_SESSION["login_account_id"] = intval ( $admin_detail["AccountID"] ) ;
			$_SESSION["login_member_email"] = $admin_detail["EmailAddress"] ;
...
<link rel="stylesheet" href="../Admin/images/all.css" />
</head>
...
<div id="container">
  ...
  <div id="mainContent">
	...
	<div id="div_Login" align="center" class="popup" style="top:15%; z-index:105; padding: 8px; width: auto;">
					...
					<td class="body">
						<div style="display: block;" class="content">
							<div id="popup">
								...
								<div id="content">
									<form action="" class="new_user"  method="post">
										<div style="margin: 0pt; padding: 0pt; display: inline;">
										</div>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="19%" height="52"><label for="user_username">Email:</label></td>
