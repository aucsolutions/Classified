				...
				<table class="formTable" cellspacing="15">
					<tr>
						...
						<td>
							...
							<span style="font-size:11px; color:#578055;">
								URL must end with / . This be the URL of Classified Script.<br />
					...
					<tr>
						...
						<td>
							...
							<span style="font-size:11px; color:#578055;">
								Database name that you created for Classified Script directory to run at.
							</span>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<span style="font-size:11px; color:#578055;">
								Database UserName that you created for Classified Script
