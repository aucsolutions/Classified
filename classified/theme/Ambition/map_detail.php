							...
							<td align="right" style="border-bottom: 1px solid rgb(192, 192, 192);">
								<table>
									<tr>
										...
										<td style="background-image:url(<?php echo base_url ?>theme/<?php echo $app_init_data["CurrentSkin"] ?>/images/print.gif); background-repeat:no-repeat; background-position:left; padding-left:17px;"><a href="#" onClick="window.print();">
										<?php echo $lang["lang_map_detail"]["str_print"] ?>
										</a></td>
