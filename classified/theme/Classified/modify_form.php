		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				<tr>
					...
					<form action="" method="post" id="form_post_ad" enctype="multipart/form-data" onSubmit="return validateForm('form_post_ad');">
						<table id="homecatgroup" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								<tr>
									<td class="adKj-rm round-middle">
										<input name="Category_post_ID" value="<?php echo $classified["CategoryID"] ?>" type="hidden">
										<table class="ad-inner" border="0" cellpadding="0" cellspacing="0">
											<tbody>
												<tr>
													<td class="ad-inner-rtl round-top-left">&nbsp;</td>
													<td class="ad-inner-rtm round-top-middle"><span style="font-weight: bolder;"><?php echo $lang["lang_post_form"]["str_ad_detail"] ?></span>													</td>
