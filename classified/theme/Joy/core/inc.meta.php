...
<link rel="stylesheet" media="screen,projection" type="text/css" href="<?php echo base_url ?>theme/<?php echo $app_init_data["CurrentSkin"] ?>/images/all.css" />
<link rel="stylesheet" media="screen,projection" type="text/css" href="<?php echo base_url ?>theme/<?php echo $app_init_data["CurrentSkin"] ?>/images/main.css" />
<link rel="stylesheet" media="print" type="text/css" href="<?php echo base_url ?>theme/<?php echo $app_init_data["CurrentSkin"] ?>/images/print.css" />
...
<script language="javascript">
	...
	function show_all_cat ( cat_id , obj_caller )
	{
		...
		if ( $("#sub_cat_"+cat_id).is(":hidden") )
			$(obj_caller).find("strong").text ( "More" ) ;
		else
			$(obj_caller).find("strong").text ( "Less" ) ;
	}
