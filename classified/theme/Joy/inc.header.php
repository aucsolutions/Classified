...
<div id="header">
        ...
        <h1 id="logo"><a href="<?php echo base_url ?>"><img src="<?php echo base_url ?>media/logo.jpg" alt="<?php echo base_url ?>" title="<?php echo $app_init_data["SiteTitle"] ?>"></a></h1>
...
?>
	...
	<div id="search-tabs" class="box">
        <ul id="search-type">
			<li>
				<?php $active = ( intval ( $home ) == 100 ?  "active" : "") ; ?>
				<a href="<?php echo base_url ?>" class="<?php echo $active ?>">
					<span><?php echo $lang["lang_footer"]["str_home_link"] ?></span>
				</a>
			</li>
			<?php
				if ( ! empty ( $static_pages ) )
						foreach ( $static_pages as $page )
						{
							...
							{
								$active = ( strchr ( $_SERVER['REQUEST_URI'] , get_sef_url ( $page["PageManagerID"] ,"StaticPage" ) ) ?  "active" : "") ;
								
							?>
					<li>
						<a href="<?php echo base_url.get_sef_url ( $page["PageManagerID"] ,"StaticPage" ) ?>/" class="<?php echo $active ?>">
							<span><?php echo $page["PageName"] ?></span>
						</a>
					</li>
        ...
        <div id="search-in">
            ...
            <div id="s01">
                <form action="<?php echo base_url ?>search/" method="post">
                    <p class="nom t-center" align="center">
						<div align="center">
						<table align="center" style="margin:2px;">
							<tr>
								<td>
									<div class="top_search_bar">
										<table width="100%" cellpadding="0" cellspacing="0" style="height:auto; margin:0px;">
											<tr>
												<td align="left"><input type="text" name="" id="search-input01" /></td>
												<td align="right">
													<?php
														if ( ! empty ( $mainCategory ) )
														{
															echo "<select name='CatId' ><option value='0'>Select Category</option>" ;
								...
								<td>
									<input type="image" value="Search" src="<?php echo base_url ?>theme/<?php echo $app_init_data["CurrentSkin"] ?>/images/search-button.gif" class="search-submit" />
								</td>
							</tr>
						</table>
						</div>
	...
	<div style="background-color:#FFF4CC; border:#E2E800 solid 2px; font-weight:bold; padding:5px; margin:3px;">
