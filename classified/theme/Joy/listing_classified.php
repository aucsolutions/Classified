...
<?php
	...
	{
?>
<script src="http://maps.google.com/maps?file=api&v=2&key=<?php echo $app_init_data["GoogleMapKey"] ?>" type="text/javascript">
</script>
<?php
	}
?>
...
?>
										...
										<div class='narrow-option expanded clearfix'>
											<span class="filterTitle" id="adTypeFilter"><?php echo $lang["lang_listing"]["str_types_selection"] ?>:</span><br>
											<ul class="child" style="list-style-type:none">
												<li><span class="selectedItem">
													<strong><?php echo $lang["lang_listing"]["str_all_types"] ?></strong>
													</span>
												</li>
												<ul class="child"  style="list-style-type:none">
													<li><span>
														<a href="<?php echo base_url.$qstring[0].$category_query_string.get_sef_search_listing_url ( $parameters , "typ" , "typ:1" ) ?>/"><?php echo $lang["lang_listing"]["str_type_offer"] ?></a>
														(<?php echo $offering_total ?>)</span>
													</li>
													<li><span>
														<a href="<?php echo base_url.$qstring[0].$category_query_string.get_sef_search_listing_url ( $parameters , "typ" , "typ:0" ) ?>/"><?php echo $lang["lang_listing"]["str_type_want"] ?></a>
														(<?php echo $wanted_total ?>) </span>
													</li>
												</ul>
											</ul>
										</div>
										<div class='narrow-option expanded clearfix'>
											<span class="filterTitle" id="adTypeFilter"><?php echo $lang["lang_listing"]["str_price"] ?>:</span><br>
											<form action="<?php echo base_url ?>search/" method="post">
												...
												<table style="width: 99%;" border="0" cellpadding="0" cellspacing="0">
													<tbody>
														<tr>
															<td id="filterContent" valign="top" width="90%"><div class="first-field">
																	<div formfield="label" class="first-label">
																		<?php echo $lang["lang_listing"]["str_price_enter"] ?>
																	</div>
					...
					?>
								<div class='narrow-option expanded clearfix'>
									<ul  style="list-style-type:none">
										<li>
											<span style="font-family: Arial; font-size: 13px; color: rgb(0, 0, 0);">
											<?php echo $lang["lang_listing"]["str_register_to_manage"] ?>
											</span>
										</li>
									</ul>
									<br>
					...
					<td valign="top">
						<div id="right-columns" style="width:700px;">
							<div id="right-inside-wrapper">
								<div class="title01-top" style="width:700px;">
								</div>
								<div class="title01">
									<div class="title01-in">
										...
										<table border="0" cellpadding="4" cellspacing="0" width="100%" >
											<tbody>
												<tr>
													<td ><strong><?php echo $lang["lang_listing"]["str_view_as"] ?></strong>
														<span class="listViewActive">&nbsp;</span>
														<a href="<?php echo base_url.$qstring[0].$category_query_string.get_sef_search_listing_url ( $parameters , "gal" , "gal:0" ) ?>/"><?php echo $lang["lang_listing"]["str_view_as_list"] ?></a>
														<span class="galleryViewActive">&nbsp;</span>
														<a href="<?php echo  base_url.$qstring[0].$category_query_string.get_sef_search_listing_url ( $parameters , "gal" , "gal:1" ) ?>/"><?php echo $lang["lang_listing"]["str_view_as_gal"] ?></a>
														&nbsp;
														<a href="<?php echo  base_url.$qstring[0].$category_query_string.get_sef_search_listing_url ( $parameters , "gal" , "gal:2" ) ?>/"><?php echo $lang["lang_listing"]["str_view_as_map"] ?></a>
													</td>
													<td align="right" width="50%" nowrap="true"><form name="sort" action="<?php echo base_url ?>search/" method="post">
															...
															<span style="color:#000000;">Sort by&nbsp;
															</span>
								...
								<div class="title01-bottom"  style="width:700px;">
								</div>
			...
			?>
									<div class="listing_list_view" >
										<table width="100%">
											<tr>
												<td width="11%" align="center"><img src="<?php echo base_url ?>classified_img.php?clsid=<?php echo $classif["AdID"] ?>" alt="No Image"></td>
												<td width="65%"><?php echo (intval ( $classif["IsOffer"] ) == 0 ? "<strong>Wanted:</strong> ":"") ?>
													<a class="listing_link" href="<?php echo base_url.get_sef_url ( $classif["AdID"] , "Classified" ) ; ?>/"><strong ><?php echo $classif["AdTitle"] ?></strong></a>
													<br>
													<?php echo substr ( strip_tags($classif["Description"]) , 0 , 300 ); ?>... <br>
												</td>
									...
									?>
												...
												<td width="12%" align="center"><?php echo date( "F j, Y" , strtotime ( $classif["DateAdded"] ) ) ?>
												</td>
											</tr>
										</table>
									</div>
			...
			?>
									<div style="background-color:#EEEEEE; padding:4px; border-bottom:#959595 solid 1px; height:10px;">
									</div>
									<?php
					}
				}
...
?>
					...
					?>
									<div class="adOuterKj">
										<div class="adFrameKj">
											<div class="adInnerKj">
												<a class="viewAd" href="<?php echo base_url.get_sef_url ( $classif["AdID"] , "Classified" ) ; ?>/" >
										...
										?>
													...
													<div class="clearfix" style="padding: 5px 15px 0pt;">
...
?>
								...
								<div id="bottomAdSense" style="clear: both;">
									<div class="bottom-adsense-divCOpt">
										<div width="100%" class="left-adsense-titleOpt" id="bottom-adsense-itemBOpt">
											<?php echo $lang["lang_listing"]["str_sponsored_links"] ?>
										</div>
							...
							?>
								...
								<table class="paginationBottomBg" border="0" cellpadding="0" cellspacing="0" width="100%">
									...
									?>
																	...
																	<td align="right">
																		<a href="<?php echo base_url ?>rss/cat:<?php echo $category_id_selected > 0 ? $category_id_selected : ""; ?>|q:<?php echo $exp_send["q"] ?>|typ:<?php echo $exp_send["typ"] ?>/">
													<img src="<?php echo base_url ?>theme/<?php echo $app_init_data["CurrentSkin"] ?>/images/xml.gif" border="0">
												</a>
																	</td>
																</tr>
															</table>
