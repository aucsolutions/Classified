		...
		<div id="page" class="box">
			...
			<div class="title01">
				<div class="title01-in">
					<h3 class="ico-info"><?php echo $lang["lang_post_form"]["str_ad_detail"] ?></h3>
				</div>
			</div>
			...
			<form action="" method="post" name="go_tohead" id="form_post_ad" enctype="multipart/form-data" onSubmit="return validateForm('form_post_ad');">
				...
				<table border="0" cellpadding="5" cellspacing="0">
					<tbody>
						...
						<tr>
							<td class="ContentBorder"><?php echo $subCat["CategoryDescription"] ?>
							</td>
						</tr>
					</tbody>
				</table>
				<div id="postAdForm">
							...
							<div class="first-input">
								<div>
									<ul style="list-style-type:none;">
										<li>
											<label>
											<input name="Is_post_Offer" value="1" checked="checked" type="radio">
											<?php echo $lang["lang_post_form"]["str_ad_type_offering"] ?>
											&nbsp;&nbsp;<font color="#666666">- <?php echo $lang["lang_post_form"]["str_ad_type_offering_desc"] ?></font>
											</label>
										</li>
										<li>
											<label>
											<input name="Is_post_Offer" value="0" type="radio">
											<?php echo $lang["lang_post_form"]["str_ad_type_want"] ?>
											&nbsp;&nbsp;<font color="#666666">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;- <?php echo $lang["lang_post_form"]["str_ad_type_want_desc"] ?></font></label>
										</li>
									</ul>
								</div>
								<div>
							...
							<div class="first-input">
								<div>
									<ul style="list-style-type:none;">
										...
										<li>
											<label>
											<input name="Price_post_Alternative" value="3" onClick="enablePriceField(3)" type="radio">
											<?php echo $lang["lang_post_form"]["str_price_free"] ?></label>
										</li>
										<li>
											<label>
											<input name="Price_post_Alternative" value="4" onClick="enablePriceField(4)" type="radio">
											<?php echo $lang["lang_post_form"]["str_price_contact"] ?></label>
										</li>
										<li>
											<label>
											<input name="Price_post_Alternative" value="5" onClick="enablePriceField(5)" type="radio">
											<?php echo $lang["lang_post_form"]["str_price_swap"] ?></label>
										</li>
									</ul>
								</div>
								<div>
					...
					<div class="input-row">
						<?php echo $lang["lang_post_form"]["str_post_instruction"] ?>. <br>
