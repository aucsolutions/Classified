							...
							<tbody>
									...
									?>
												...
												<?php
													...
													echo "<a href='".base_url."c-CategorySelect/".$cat["CategoryID"]."/'><h2 class='homeMetaCatName'><img src='".$temp_src."' style='vertical-align: middle; position: relative; left: -5px;' border='0' vspace='1' />" ;
													
													echo $cat["CategoryName"]."</h2></a>" ;
