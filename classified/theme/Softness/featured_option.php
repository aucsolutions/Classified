												...
												<tbody>
													...
													<tr>
														...
														<td class="ad-inner-rm round-middle"><div id="postAdForm">
																...
																<table id="Images" border="0" width="100%" cellpadding="0" cellspacing="0">
																	<tbody>
																		<tr>
																			
																			<td valign="top" align="left"><div style="">
																					<table cellpadding="5" cellspacing="3" style="font-size:14px;">
																						<tr>
																...
																<div class="postAd">
																	...
																	<form action="" method="post" name="frm_plans">
																		<div style="margin:8px;" align="center">
																			<ul id="ul_featured" style="display:none; list-style-type:none; text-align:left;">
																		...
																		?>
																				<li style="margin-top:5px; padding:3px;">
																					...
																					<?php
																						echo $app_init_data["CurrencySymbol"]." ".$plan["Amount"] . " (".$plan["DaysToExpire"]." days)" ;
																					?>
																					&nbsp;&nbsp;
																					</label>
																				</li>
