...
The Category You selected require <?php echo $app_init_data["CurrencySymbol"].$price ?>
...
<input type="hidden" name="return" value="<?php echo base_url ?>c-CategorySelect/<?php echo $sel_id ?>/pp-Return/" />
...
<input type="submit" value="Click here to Confirm Payment" />
</form>
