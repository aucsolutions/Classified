...
<div id="main" style="width: 100%;">
	...
	<div id="middle">
				...
				<table width="100%">
					<tr>
						...
						<td width="31%" align="right">
							<a href="<?php echo base_url ?>c-CategorySelect/<?php echo intval ( $category_id_selected ) ?>/"> <img style="vertical-align: middle; position: relative; left: -5px;" src="<?php echo base_url ?>theme/<?php echo $app_init_data["CurrentSkin"] ?>/images/post_a_classified_ad.gif" border="0"> <?php echo $lang["lang_listing"]["str_post_ad_free"] ?></a> &nbsp;
						</td>
					</tr>
				</table>
		...
		<table style="clear: both;" border="0" cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				<tr>
					<td valign="top" width="260"><div id="sbLeftNav" class="styleA">
